...
!define /file VERSION version_dev.txt
...
Name "DNSRelayServerSetup ${VERSION} alpha"

; The file to write
OutFile "..\..\Setup installation\test versions (bugged)\DNSRelayServerSetup_${VERSION}_alpha.exe"
